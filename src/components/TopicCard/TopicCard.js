...
export default function TopicCard({ questionData }) {
      ...
      return (
        <Fade duration={500 + index * 0.4} key={index}>
          <div className="col mb-4">
            ...
            >
              <Card
                className={`mb-3 inprogress-card   ${
                  dark ? "darkCard" : ""
                }`}
              >
                <Card.Body>
      ...
      return (
        <Fade duration={500 + index * 50} key={index}>
          <div className="col mb-4">
            ...
            >
              <Card
                className={`mb-3 notstarted-card hvr-grow animate__animated animate__flash ${
                  dark ? "darkCard" : ""
                }`}
              >
                <Card.Body>
                  ...
                  <button type="button" class="btn btn-outline-info start-btn">Start Now</button>
                </Card.Body>
              </Card>
            </Link>
          </div>
  ...
  return (
    ...
    <h1  className='app-heading text-center mt-5' style={{ color: dark ? 'white' : '' }}>
				...
				<h6  className='text-center mt-5' style={{ color: dark ? 'white' : '' }}>
				<button class='submit'  onClick={handleLogOut }> Logout</button>
				</h6>
   ...
   <h3 className="app-heading2 text-center mb-3">
    ...
    <h4 className="hh text-center mb-4">
      {totalSolved
